...
<body>
    ...
    <div class="container">
        ...
        echo "<a href='category_create.php' class='btn btn-primary m-b-1em mb-3'>Create New Customer</a>";
        ...
        if ($num > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                // we will use this links on next part of this post
                echo '<a href="javascript: void(0)" onclick="delete_user('.$id.');"  class="btn btn-danger">Delete</a>';
                echo "</td>";
                echo "</tr>";
            }
